...
public class Gasto{
    ...
    public static Gasto getGastoRandom() {
        Gasto c = new Gasto();
        c.id = intRand(10000,20000);
     
        c.tipoDeGasto = tipoDeGastoRandom();
        c.empresa = empresaRandom();
        c.monto = (int) montoRandom(0, 10000000);
        c.fecha = fechaRandom();

        return c;
    }

    public Gasto(int id, String tipoDeGasto, String empresa, String fecha,
            int monto) {
        this.id = id;
    ...
    public Gasto(String losAtributos) {
        ...
        this.monto = Integer.valueOf(separados[4]);
    ...
    private static double montoRandom(int d, int h) {
