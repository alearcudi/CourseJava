...
public class Teclado
{
    ...
    public static char leerChar(String mensaje){
        ...
        while (!salir){
            try{
                ...
                System.out.println("Debe ingresar nuevamente!!\n");
            }
        }
        return c;
    }
    ...
    public static float leerFloat(String mensaje, float limInf, float limSup){
        ...
        do{
            try{
                n = new Float(leerTexto(mensaje)).floatValue();
                if (n < limInf || n > limSup){
                    println("Dato fuera de rango (" + limInf + " ... " + limSup + ") \n");
                }
            } 
    ...
    public static double leerDouble(String mensaje){
        ...
        while (!salir){
            try{
                n = new Double(leerTexto(mensaje)).doubleValue();
                salir = true;
            } 
            catch (NumberFormatException e){
                println(MENSAJE_ERROR_NUMERICO + "\n");
    ...
    public static boolean confirma(String cartel) {
        return Character.toUpperCase(leerChar(cartel,"SsNn"))=='S';
    }
}
